...
<div class="space-y-6">
    ...
    <div class="flex items-center space-x-4">
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-gray-400">Update informasi pengguna</p>
        </div>
    </div>
    ...
    <div class="bg-gray-800 rounded-lg shadow-xl border border-gray-700">
        <div class="p-6 border-b border-gray-700 bg-gradient-to-r from-purple-500 to-pink-500">
            <div class="flex items-center">
                <div class="flex-shrink-0 h-12 w-12 rounded-full bg-white/20 flex items-center justify-center text-white font-bold text-lg">
        ...
        <form action="{{ route('admin.users.update', $user) }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="border-t border-gray-700 pt-6">
                <h3 class="text-sm font-medium text-gray-300 mb-4">Ubah Password (Opsional)</h3>
            ...
            <div class="border-t border-gray-700 pt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <!-- Admin Role -->
                    <label class="relative flex items-start p-4 bg-gray-900 border-2 {{ old('role', $user->role) == 'admin' ? 'border-red-500' : 'border-gray-700' }} rounded-lg cursor-pointer hover:border-red-500 transition-all group">
                        <input type="radio" 
                               name="role" 
                               value="admin" 
                        ...
                        <div class="ml-3">
                            <div class="flex items-center">
                                ...
                                <span class="ml-2 inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-red-900 text-red-300 border border-red-700">
                                    Full Access
                                </span>
                            </div>
                    ...
                    <label class="relative flex items-start p-4 bg-gray-900 border-2 {{ old('role', $user->role) == 'general_manager' ? 'border-purple-500' : 'border-gray-700' }} rounded-lg cursor-pointer hover:border-purple-500 transition-all group">
                        <input type="radio" 
                               name="role" 
                               value="general_manager" 
                               {{ old('role', $user->role) == 'general_manager' ? 'checked' : '' }}
                        ...
                        <div class="ml-3">
                            <div class="flex items-center">
                                ...
                                <span class="ml-2 inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-purple-900 text-purple-300 border border-purple-700">
                                    Manager
                                </span>
                            </div>
                    ...
                    <!-- Technician Role -->
                    <label class="relative flex items-start p-4 bg-gray-900 border-2 {{ old('role', $user->role) == 'technician' ? 'border-blue-500' : 'border-gray-700' }} rounded-lg cursor-pointer hover:border-blue-500 transition-all group">
                        <input type="radio" 
                               name="role" 
                               value="technician" 
                               {{ old('role', $user->role) == 'technician' ? 'checked' : '' }}
                        ...
                        <div class="ml-3">
                            <div class="flex items-center">
                                ...
                                <span class="ml-2 inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-900 text-blue-300 border border-blue-700">
                                    Support
                                </span>
                            </div>
                    ...
                    <!-- User Role -->
                    <label class="relative flex items-start p-4 bg-gray-900 border-2 {{ old('role', $user->role) == 'user' ? 'border-green-500' : 'border-gray-700' }} rounded-lg cursor-pointer hover:border-green-500 transition-all group">
                        <input type="radio" 
                               name="role" 
                               value="user" 
                        ...
                        <div class="ml-3">
                            <div class="flex items-center">
                                ...
                                <span class="ml-2 inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-green-900 text-green-300 border border-green-700">
                                    Standard
                                </span>
                            </div>
