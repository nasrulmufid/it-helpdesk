...
@section('content')
    ...
    <div class="bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl p-8 mb-8 text-white">
        ...
        <p class="text-purple-100">Kelola tiket IT support Anda dengan mudah</p>
    </div>
    ...
    <div class="bg-gray-800 rounded-xl p-6 border border-gray-700 mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <a href="{{ route('tickets.create') }}"
                class="flex items-center p-4 bg-gradient-to-r from-purple-600 to-pink-600 rounded-lg hover:from-purple-700 hover:to-pink-700 transition-all transform hover:scale-105">
                <svg class="w-8 h-8 text-white mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                </svg>
                <div>
                    <p class="text-white font-semibold">Buat Tiket Baru</p>
                    <p class="text-purple-200 text-sm">Laporkan masalah Anda</p>
                </div>
            </a>
            <a href="{{ route('tickets.index') }}"
                class="flex items-center p-4 bg-gray-700 rounded-lg hover:bg-gray-600 transition-all transform hover:scale-105">
                ...
                <div>
                    <p class="text-white font-semibold">Lihat Semua Tiket</p>
                    <p class="text-gray-400 text-sm">Kelola tiket Anda</p>
                </div>
            </a>
            <div class="flex items-center p-4 bg-gray-700 rounded-lg">
                ...
                <div>
                    ...
                    <p class="text-gray-400 text-sm">~2 jam rata-rata</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-700 flex items-center justify-between">
            <h2 class="text-xl font-bold text-white">Tiket Saya</h2>
            ...
            <table class="w-full">
                <thead class="bg-gray-700">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Teknisi
                        </th>
