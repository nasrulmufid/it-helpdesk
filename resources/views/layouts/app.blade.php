                ...
                <header class="bg-gray-800 border-b border-gray-700 z-10">
                    <div class="flex items-center justify-between px-6 py-4">
                        ...
                        <div class="hidden lg:flex items-center space-x-4">
                            <form method="GET" action="{{ route('tickets.index') }}" class="w-96">
                                @foreach(['status', 'priority', 'assigned_to'] as $param)
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="q" value="{{ request('q') }}"
                                        class="w-full pl-10 pr-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition"
                                        placeholder="Cari nama user / No Ticket">
                                </div>
                            </form>
                            <!-- Notification Bell -->
                            <div class="relative">
